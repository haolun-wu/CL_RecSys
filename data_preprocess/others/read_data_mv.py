...
class mv(DatasetLoader):
    def __init__(self, data_dir):
        self.fpath_rate = os.path.join(data_dir, 'user_ratedmovies.dat')
        self.fpath_tag = os.path.join(data_dir, 'movie_tags.dat')
    ...
    def load(self):
        ...
        df_rate = pd.read_csv(self.fpath_rate,
                              sep='\t',
                              engine='python',
                              names=['user', 'item', 'rate', 'day', 'month', 'year', 'hour', 'minute', 'second'],
...
class Data(object):
    def __init__(self, data_dir, val_ratio=None, test_ratio=0.2, user_filter=5, item_filter=5, seed=0):
        ...
        # draw_distribution(df[['user', 'item']], 'user', 'item', "mv")
        # draw_distribution(IT_df, 'item', 'tag', "mv")
        # draw_distribution(IT_df, 'tag', 'item', "mv")
