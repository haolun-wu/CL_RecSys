...
class lastfm(DatasetLoader):
    ...
    def load(self):
        ...
        df = pd.read_csv(self.fpath,
                         sep='\t',
                         engine='python',
                         names=['user', 'item', 'tag', 'day', 'month', 'year'],
                         usecols=['user', 'item', 'tag'],
                         skiprows=1).drop_duplicates()

        # df_tag_name = pd.read_csv('../data/hetrec-lastfm/tags.dat',
        #                           sep='\t',
        #                           encoding = "ISO-8859-1",
        #                           # engine='python',
        #                           names=['tag', 'name'],
        #                           skiprows=1)
        # print("df_tag_name:", df_tag_name)

        # return df, df_tag_name
        return df
...
class Data(object):
    def __init__(self, data_dir, val_ratio=None, test_ratio=0.2, user_filter=5, item_filter=5, seed=0):
        ...
        # print("df_tag_mapping:", df_tag_mapping)
        # df_tag_mapping.to_pickle("/home/haolun/projects/UIT/saved/lastfm/tagname_mapping.pkl")
...
if __name__ == '__main__':
    parser = parser_args()
    data_dir = '../data/hetrec-lastfm/user_taggedartists.dat'
